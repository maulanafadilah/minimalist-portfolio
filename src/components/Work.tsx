...
function WorkItem({ company, period, title, body, stats, delay = '0ms' }: WorkItemProps) {
    ...
    <section id="work">
      <WorkItem
        ...
        body={[
          ...
          "When the product needed things React Native couldn't do cleanly — noise suppression, audio recording — I wrote the native modules myself in Swift and Kotlin.",
        ]}
        stats={['50K+ MAU', '4.4★ Google Play', '99.6% crash-free', '18 releases']}
      />
      <WorkItem
